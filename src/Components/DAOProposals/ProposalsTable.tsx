...
const ProposalsTable = () => {
  ...
  const fetchProposalsData = async () => {
    try {
        ...
        const response: any[] = await getJson(`https://euphoria-backend-production.up.railway.app/api/profile/celebrities?status=pending`);
...
// working good
  ...
  //   try {
  //     // Fetch proposals data
  //     const response = await getJson("https://euphoria-backend-production.up.railway.app/api/profile/celebrities?status=pending");
  //     console.log("response", response);
  ...
  //     "https://euphoria-backend-production.up.railway.app/api/profile/celebrities?status=pending"
  //   );
  //   if (response) {
  //     // setData(response);
